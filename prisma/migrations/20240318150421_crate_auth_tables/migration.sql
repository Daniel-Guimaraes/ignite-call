...
INSERT INTO "new_account" ("access_token", "id", "provider_account_id", "refresh_token", "user_id") SELECT "access_token", "id", "provider_account_id", "refresh_token", "user_id" FROM "account";
DROP TABLE "account";
